...
from .const import CONF_LLM_HASS_API, CONF_RECOMMENDED, DEFAULT_TITLE, DOMAIN
...
class AIHubConfigFlow(ConfigFlow, domain=DOMAIN):
    ...
    def async_get_supported_subentry_types(
        ...
        return {subentry_type: AIHubSubentryFlowHandler for subentry_type in SUBENTRY_TYPES.values()}
